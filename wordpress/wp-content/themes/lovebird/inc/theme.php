...
define('LOVEBIRD_THEME_URL','https://wwwows.com/product/lovebird-wordpress-theme/');
define('LOVEBIRD_SOCIAL_URL','https://www.facebook.com/wwwows/');
define('LOVEBIRD_DOCS_URL','https://wwwows.com/docs');

// Upgrade content
if ( ! function_exists( 'lovebird_admin_theme_page_more_features' ) ) {
	function lovebird_admin_theme_page_more_features() { ?>
<div class="wwwows-tp-s-box wwwows-tp-premium">
    <h4><?php esc_html_e( 'Lovebird Premium', 'lovebird' ); ?></h4>
    <p><?php esc_html_e( 'If You need the premium features for Your site, check the theme page on wwwows.com', 'lovebird' ); ?></p>
    <a href="<?php echo esc_url(LOVEBIRD_THEME_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Get Lovebird Premium', 'lovebird' ); ?></a>
</div>
<?php
	}
}
...
// Title content
if ( ! function_exists( 'lovebird_admin_theme_page_title' ) ) {
	function lovebird_admin_theme_page_title() { ?>
<div class="wwwows-tp-title-area">
    <div class="wwwows-tp-title-content">
        <h1><?php esc_html_e( 'Lovebird WordPress Theme', 'lovebird' );?></h1>
        <p><?php esc_html_e( 'Thank You for using Lovebird! Check all the theme features.', 'lovebird' );?></p>
    </div>
    <h2><?php esc_html_e( 'Here You can see the theme features. At the theme page on wwwows.com You can find more details.', 'lovebird' );?></h2>
</div>
<?php
	}
}    
 
// Lovebird admin page content   
if ( ! function_exists( 'lovebird_admin_theme_page' ) ) {
	function lovebird_admin_theme_page() { ?>
<div id="wwwows-tp-page-body">
<div id="wwwows-tp-page-left">
	<?php lovebird_admin_theme_page_title(); ?>
    <div class="wwwows-theme-features">
        <h3 class="wpp-heading"><span>Free</span> Lovebird features</h3>
        
        <div class="clearflex"></div>
        
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(LOVEBIRD_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Full Site Editor', 'lovebird' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(LOVEBIRD_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Fast Pageload', 'lovebird' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(LOVEBIRD_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'GPL License', 'lovebird' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(LOVEBIRD_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Partial Block Templates', 'lovebird' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(LOVEBIRD_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Translation Ready', 'lovebird' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span>Premium</span> Lovebird features</h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Additional Full Block Templates', 'lovebird' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'WooCommerce Ready', 'lovebird' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Google Fonts Options', 'lovebird' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Wwwows Blocks', 'lovebird' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span>Additional blocks</span> for Lovebird premium</h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll animations', 'lovebird' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Responsive control', 'lovebird' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Back to top', 'lovebird' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Image cursor', 'lovebird' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Stylish scrollbar', 'lovebird' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Accordion', 'lovebird' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Countdown', 'lovebird' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Icon', 'lovebird' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Progress', 'lovebird' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll text', 'lovebird' ); ?></h4>
        </div>
...
<div id="wwwows-tp-page-right">
	<?php lovebird_admin_theme_page_more_features(); ?>
	<div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows Documentation', 'lovebird' ); ?></h4>
        <p><?php esc_html_e( 'If You`ve stuck, the documentation may help on Wwwows.com', 'lovebird' ); ?></p>
        <a href="<?php echo esc_url(LOVEBIRD_DOCS_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Wwwows Documentation', 'lovebird' ); ?></a>
    </div>
    <div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows on Facebook', 'lovebird' ); ?></h4>
        <p><?php esc_html_e( 'If You want to get useful infos and discounts about Wwwows, follow Wwwows on Facebook.', 'lovebird' ); ?></p>
        <a href="<?php echo esc_url(LOVEBIRD_SOCIAL_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Go to Facebook', 'lovebird' ); ?></a>
    </div>
</div>
<?php
	}
